    ...
    <div className='fund-container'>
        ...
        <div className="fund-main-container">
            <div className='fund-card-container'>
                <h3>A STUDY ON THE INTERNAL DIVERSITY OF SOCIO-CULTURAL HERITAGE OF BUDDHIST COMMUNITIES IN BANGLADESH.</h3>
                <div className="fund-main-title">
                    <p>Principle Investigator: <span>Dr. Suman Kanti Barua , Professor , Department of Pali and Buddhist Studies</span></p>
                    <p>Co-Investigator:</p>
                    <section>
